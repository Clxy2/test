 ...
 * @author Shane Bryzak
 */
@Interceptor(stateless = false, around = { RollbackInterceptor.class,
        BusinessProcessInterceptor.class, ConversationInterceptor.class, BijectionInterceptor.class })
public class TransactionInterceptor extends AbstractInterceptor {
    ...
    public Object aroundInvoke(final InvocationContext invocation) throws Exception {
        return new Work() {
            ...
            protected boolean isNewTransactionRequired(boolean transactionActive) {
                return isNewTransactionRequired(invocation.getMethod(), getComponent()
                        .getBeanClass(), transactionActive);
            }

            private boolean isNewTransactionRequired(Method method, Class beanClass,
    ...
    public boolean isInterceptorEnabled() {
        ...
        // return getComponent().getType()==JAVA_BEAN &&
        // getComponent().beanClassHasAnnotation(Transactional.class);
        return getComponent().getType() == JAVA_BEAN
                && (getComponent().beanClassHasAnnotation(Transactional.class) || getComponent()
                        .beanClassHasAnnotation(cn.clxy.tools.core.tx.Transactional.class));
    }
